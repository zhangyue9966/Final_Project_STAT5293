...
Besides the data we get directly from Yelp, we also want to explore the relationship of differnt crusine and the boroughs they belong to. Because Yelp does not prodive the details, we used the latitude and longitude information to join our dataset with the borough infromation. As the result we have the all_data with the following vairables.
